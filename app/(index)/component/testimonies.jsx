...
const testimonies = () => {
  return (
    <div className="py-4 pb-20 px-8 md:px-0">
        <h2 className="text-3xl p-8 pb-12 font-bold text-center">New Belivers Testimonies...</h2>
        <div className="flex flex-wrap gap-12 lg:gap-16 justify-evenly">
