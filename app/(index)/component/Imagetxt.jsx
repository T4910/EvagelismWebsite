...
const ImageWithText = ({ url, children }) => {
  return (
    <div className="relative rounded-xl my-16">
      ...
      <div className="absolute inset-0 grid items-center text-white text-4xl w-full text-center font-bold hover:scale-125 transition-all duration-500 ease-in-out">
